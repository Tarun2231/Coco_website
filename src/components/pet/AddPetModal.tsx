      ...
      <div className="space-y-3">
          ...
          {steps.map((s) => {
            ...
            return (
              <button
                ...
                className={`py-1.5 px-1 rounded-lg text-[10px] sm:text-xs font-black flex items-center justify-center gap-1 transition-all ${
                  isActive
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {step === 1 && (
            <div className="space-y-2.5 animate-fadeIn">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-700 uppercase mb-0.5">Gender</label>
                  <select
                    name="gender"
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-700 uppercase mb-0.5">Breed *</label>
                <input
                  type="text"
                  name="breed"
                  required
          ...
          {step === 3 && (
            <div className="space-y-2.5 animate-fadeIn">
              <div>
                <label className="block text-[11px] font-bold text-slate-700 uppercase mb-0.5">Pet Photo URL</label>
                <input
                  type="url"
                  name="photo"
              ...
              <div className="flex flex-col items-center p-2 bg-slate-50 rounded-2xl border border-slate-100">
                <span className="text-[11px] text-slate-500 font-medium mb-1">Photo Preview:</span>
                <img
                  src={formData.photo}
                  alt="Preview"
                  className="w-20 h-20 rounded-2xl object-cover border-2 border-brand-coral/40 shadow-xs"
                />
              </div>
